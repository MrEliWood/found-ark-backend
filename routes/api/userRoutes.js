					...
					include: [
						{
							model: Group,
							as: 'joined',
							where: { '$characters.joined.groupmember.approved$': true },
							required: false
						},
						{
							model: Group,
							as: 'applied',
							where: { '$characters.applied.groupmember.approved$': false },
							required: false
						},
						{
							model: Group,
							...
							include: [
								{
									...
									where: { '$characters.joined.member_char.groupmember.approved$': true },
									required: false
								},
								{
									model: Tag,
